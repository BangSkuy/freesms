...
class Sms:
	...
	def menu(self):
		...
		time.sleep(1)
		print("\033[1;37mTool   : \033[1;34mSMS GRATIS SEUMUR HIDUP")
		time.sleep(1)
		print("\033[1;37mMOD    : \033[1;36mBANG SKUY")
		time.sleep(1)
		print("\033[1;37mCODE   : \033[1;37mFREE-SMS")
		time.sleep(1)
		print("\033[1;37mTeam   : \033[1;32mERROR 501")
		time.sleep(1)
		print("\033[1;37mYoutube: \033[1;33mBANG SKUY")
		time.sleep(1)
		print("\033[1;31m______________________________________________\n")
		os.system('xdg-open https://youtube.com/@##https://github.com/w3x-nmhd8qXv9Xdm_UneUg')
		o=int(0)
		time.sleep(2)
		nomer=int(input("\033[1;37m[\033[1;32m?\033[1;37m] \033[1;37mNOMER TUJUAN: \033[1;32m"))
		...
		print("\033[1;31m______________________________________________")
		if jumlah > 100:
			exit("\033[1;37m[\033[1;31m!\033[1;37m] Gunakan Dengan Bijak Ya Kntd!!\n\033[1;37m[\033[1;31m!\033[1;37m] Sekali ngirim 100 aja\n")
		else:
	...
	def main(self,nomer,jun):
		...
		if 'PESAN GRATIS DIKIRIM' in str(pek):
			print("\033[1;37m[\033[1;31m!\033[1;37m] MENGIRIM PESAN KE",nomer,"\033[1;37m[\033[1;31mFAILED\033[1;37m]")
		else:
			print("\033[1;37m[\033[1;32m+\033[1;37m] MENGIRIM SMS KE",nomer,"\033[1;37m[\033[1;32mSUCCESS\033[1;37m]")
